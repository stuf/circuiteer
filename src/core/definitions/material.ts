...
export const NaturalResourceDict = Object.entries(naturals).reduce(
  (o, [k, mat]) => ({ ...o, [k]: mkBaseMaterial(mat) }),
  {} as Record<NaturalKeys, IBaseMaterial>,
);
